...
def test_classdata_comparison():
  ...
  class1 = ClassData(studio, location, "PILATES (Wunda Chair) Essential 60", "Instructor A", "08:00 AM", availability, capacity_info)
  class2 = ClassData(studio, location, "PILATES (Reformer) Fit & Tone 60 - Rm1", "Instructor B", "09:00 AM", availability, capacity_info)
