...
class HistoryManager:
  """
  Manages history data and interactions between the Telegram bot and users.
  This class handles saving interactions between the Telegram bot and users.
  ...
  def start(self) -> None:
    ...
    If an existing file has mismatched headers, it renames the old file and creates a new one.
    """
