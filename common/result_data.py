          ...
          for class_details in self.classes[date_to_check]:
            ...
            if week == 0 and day == 0: # Skip classes that have already ended
              if (
                ...
                or current_sg_time.hour == class_time.hour and current_sg_time.minute > class_time.minute
              ):
                continue
            ...
            if len(query.start_times) > 0:
              ...
              for start_time_from, start_time_to in query.start_times:
                class_time_within_query_time_from = (
                  class_time.hour > start_time_from.hour or
                  class_time.hour == start_time_from.hour and class_time.minute >= start_time_from.minute
                )
                class_time_within_query_time_to = (
                  class_time.hour < start_time_to.hour or
                  class_time.hour == start_time_to.hour and class_time.minute <= start_time_to.minute
                )
