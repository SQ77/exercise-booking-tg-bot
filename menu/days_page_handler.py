...
def days_selection_handler(
  ...
  """
  Displays the days selection prompt and updates the days selection message of the chat.
...
def days_next_callback_query_handler(
  ...
  """
  Handles the callback query when the user proceeds to the next step after selecting the day(s).
  If no day(s) are selected, returns to the days selection page. Otherwise, proceeds back to the main page.
