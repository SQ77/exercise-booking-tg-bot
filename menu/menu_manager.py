...
class MenuManager:
  """
  MenuManager handles setting up various message and callback query handlers for the Telegram bot.
  It is responsible for managing user interactions related to studios, instructors, schedules, and more.
